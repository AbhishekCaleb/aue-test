...
## Environments
- Preview: https://main--aue-test--AbhishekCaleb.aem.page/
- Live: https://main--aue-test--AbhishekCaleb.aem.live/
...
1. Open the `aue-test` directory in your favorite IDE and start coding :)
